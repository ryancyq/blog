---
date: 2025-04-08
title: Building a Static Site with Jekyll and Tailwind CSS v4
...
If you are looking to upgrade from Tailwind CSS 4 to 3, see [Tailwind CSS Upgrade Guide].
...
npm init -y
npm install --save-dev @tailwindcss/postcss postcss cssnano autoprefixer
```
...
[Deploy Jekyll to GitHub Pages with Tailwind CSS]: posts/deploy-jekyll-with-tailwindcss-via-github-actions
[Tailwind CSS Upgrade Guide]: https://tailwindcss.com/docs/upgrade-guide#using-the-upgrade-tool
